#!/usr/bin/env python3
"""
Generate HTML pages for all chapters and projects
...
projects = [
    {
        ...
        "icon": "fas fa-tasks",
        "difficulty": "Beginner",
        "markdown_file": "../projects/todo-app/README.md"
    },
    {
        "id": "blog-platform",
        "title": "Blog Platform",
        ...
        "markdown_file": "../projects/blog-platform/README.md"
    },
    {
        "id": "shop-app",
        ...
        "difficulty": "Advanced",
        "markdown_file": "../projects/shop-app/README.md"
    },
    {
        "id": "rest-api",
        "title": "REST API",
        ...
        "icon": "fas fa-code",
        "difficulty": "Intermediate",
        "markdown_file": "../projects/rest-api/README.md"
    },
    {
        "id": "wizard-form",
        ...
        "icon": "fas fa-magic",
        "difficulty": "Advanced",
        "markdown_file": "../projects/wizard-form/README.md"
    }
]
...
def convert_markdown_to_html(markdown_file_path):
    ...
    try:
        ...
        html_content = re.sub(r'<h4>(.*?)</h4>', r'<h4 class="subsubsection-title">\1</h4>', html_content)
        
        # Style code blocks
        html_content = re.sub(r'<pre><code>(.*?)</code></pre>', r'<pre><code class="language-php">\1</code></pre>', html_content, flags=re.DOTALL)
        
        # Style inline code
        html_content = re.sub(r'<code>(.*?)</code>', r'<code class="inline-code">\1</code>', html_content)
        
        # Style lists
        html_content = re.sub(r'<ul>(.*?)</ul>', r'<ul class="content-list">\1</ul>', html_content, flags=re.DOTALL)
        html_content = re.sub(r'<ol>(.*?)</ol>', r'<ol class="content-list">\1</ol>', html_content, flags=re.DOTALL)
        
        # Style blockquotes
        html_content = re.sub(r'<blockquote>(.*?)</blockquote>', r'<blockquote class="content-blockquote">\1</blockquote>', html_content, flags=re.DOTALL)
...
def create_chapter_template(chapter, markdown_content=None, error=None):
    ...
    if markdown_content:
        ...
        <div class="alert alert-warning">
            ...
            <strong>Content not available:</strong> {error}
        </div>
        <div class="card mb-4">
        ...
        <div class="alert alert-info">
            ...
            <strong>Content coming soon!</strong> This chapter is being prepared.
        </div>
        <div class="card mb-4">
            <div class="card-header">
                <h3>Chapter Overview</h3>
            ...
            <div class="card-body">
                <p>This chapter covers the fundamentals of Laravel development. You'll learn:</p>
                <ul>
                    <li>Key concepts and principles</li>
                    <li>Practical implementation examples</li>
                    <li>Best practices and common patterns</li>
...
<head>
    ...
    <title>Chapter {chapter["id"][:2]}: {chapter["title"]} - Laravel: From Zero to Production</title>
            ...
            <div class="col-lg-8 mx-auto">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Chapter {chapter["id"][:2]}: {chapter["title"]}</li>
                    </ol>
                </nav>

                <article class="chapter-content">
                    <h1 class="display-4 text-gradient mb-4">
                        <i class="{chapter["icon"]}"></i> Chapter {chapter["id"][:2]}: {chapter["title"]}
                    </h1>
...
def create_project_template(project, markdown_content=None, error=None):
    ...
    if markdown_content:
        ...
        <div class="alert alert-info">
            <i class="fas fa-info-circle"></i>
            <strong>Project coming soon!</strong> This project is being prepared.
        </div>
        <div class="card mb-4">
            <div class="card-header">
                <h3>Project Overview</h3>
            ...
            <div class="card-body">
                <p>This project will teach you how to build a real-world application using Laravel. You'll learn:</p>
                <ul>
                    <li>Real-world application development</li>
                    <li>Laravel best practices</li>
                    <li>Database design and relationships</li>
                ...
                <article class="project-content">
                    ...
                    <div class="card mt-4">
                        <div class="card-body text-center">
                            ...
                            <a href="{project["markdown_file"]}" class="btn btn-outline-primary" target="_blank">
                                <i class="fas fa-external-link-alt"></i> Open Markdown File
                            </a>
                        </div>
                    </div>
...
def main():
    ...
    print("\nGenerating project pages with Markdown conversion...")
    for project in projects:
        filename = f"{project['id']}.html"
        filepath = projects_dir / filename
        
        # Convert Markdown to HTML
        markdown_content, error = convert_markdown_to_html(project["markdown_file"])
        
        with open(filepath, 'w', encoding='utf-8') as f:
            f.write(create_project_template(project, markdown_content, error))
    ...
    print("- ✅ Responsive design and navigation")
